...
{
public class SurveyCell : UITableViewCell
    {
        UILabel dayLabel;
       ...
       // static UIImage calendarImageSmall = UIImage.FromFile(AppDelegate.ImageCalendarPhone);
        ...
        public SurveyCell(string caption, string day, NSString cellId) : base(UITableViewCellStyle.Default, cellId)
        {
        ...
        public void UpdateCell(string caption, string day)
        {
            UIImage image;
